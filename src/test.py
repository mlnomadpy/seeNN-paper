...
if __name__ == '__main__':
    ...
    parser.add_argument('--edge', type=bool,default=True,  help='Edge Modality On/OFF')
    ...
    parser.add_argument('--trainable_epochs', type=int, default=0, help='The number of epochs before the backbone become trainable')
    ...
    parser.add_argument('--num_heads', type=int, default=2, help='Num Heads for Multihead Attention')
